...
public class DataReadingResource {
    ...
    public ResponseEntity<List<DataReading>> getDataReadingByPlantId(@PathVariable String PlantID) {
        log.debug("REST request to get dataReading with sensor ID : {}", PlantID);
