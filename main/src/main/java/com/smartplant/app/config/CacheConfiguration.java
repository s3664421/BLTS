package com.smartplant.app.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.smartplant.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.smartplant.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
