...
public class DataReadingResourceIT {
    ...
    private static final Long DEFAULT_TEMP = 1L;
    private static final Long UPDATED_TEMP = 2L;

    private static final Long DEFAULT_HUMIDITY = 1L;
    private static final Long UPDATED_HUMIDITY = 2L;

    private static final Long DEFAULT_LIGHT = 1L;
    private static final Long UPDATED_LIGHT = 2L;

    private static final Long DEFAULT_MOISTURE = 1L;
    private static final Long UPDATED_MOISTURE = 2L;
    ...
    public void getAllDataReadings() throws Exception {
        ...
        restDataReadingMockMvc.perform(get("/api/data-readings?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].temp").value(hasItem(DEFAULT_TEMP.intValue())))
            .andExpect(jsonPath("$.[*].humidity").value(hasItem(DEFAULT_HUMIDITY.intValue())))
            .andExpect(jsonPath("$.[*].light").value(hasItem(DEFAULT_LIGHT.intValue())))
            .andExpect(jsonPath("$.[*].moisture").value(hasItem(DEFAULT_MOISTURE.intValue())));
    }
    ...
    public void getDataReading() throws Exception {
        ...
        restDataReadingMockMvc.perform(get("/api/data-readings/{id}", dataReading.getId()))
            ...
            .andExpect(jsonPath("$.temp").value(DEFAULT_TEMP.intValue()))
            .andExpect(jsonPath("$.humidity").value(DEFAULT_HUMIDITY.intValue()))
            .andExpect(jsonPath("$.light").value(DEFAULT_LIGHT.intValue()))
            .andExpect(jsonPath("$.moisture").value(DEFAULT_MOISTURE.intValue()));
    }
